...
if(curreNode.data.equals(data)) {
	...
	public boolean contains(SinglyLinkedListPractise9<T> list1, T data) {
	...
	public static <T> SinglyLinkedListPractise9<T> Union(SinglyLinkedListPractise9<T> list1, SinglyLinkedListPractise9<T> list2){
		...
		SinglyLinkedListPractise9<T>.Node currentNode = list2.headNode;
